function convertToRoman(num) {
    ...
    function addRomanNum(decimalPlace, highDecimalPlace, romVar, lowLetter, highLetter, secondHighLetter) {
        if (decimalPlace > 3  && highDecimalPlace === 0) { //resolves #4 issues
            numRoman.push(lowLetter, highLetter);
        }
        else if (decimalPlace > 3 && highDecimalPlace !== 0) { //resolves #9 issues
            numRoman.pop();
